...
apt-get install -y openbox obconf xinit lxappearance compton xfce4-screenshooter xfce4-clipman xfce4-power-manager arandr gsimplecal xcape gparted file-roller yad
